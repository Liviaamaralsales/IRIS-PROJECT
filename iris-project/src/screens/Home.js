      ...
      >
        ...
        <View style={styles.whiteBody}>
          ...
          <View style={styles.row}>
            ...
            {/* BOTÃO REPORT ATUALIZADO COM reportImg.png */}
            <TouchableOpacity style={styles.outlineButton}>
              <Image 
                source={require("../reportImg.png")} 
...
const styles = StyleSheet.create({
  ...
  iconText: { fontSize: 30, fontWeight: 'bold', color: '#333' },
  bellBadge: {
  ...
  // ESTILO PARA A NOVA IMAGEM DO REPORT
  reportButtonImage: {
    width: 20,
    height: 20,
    marginRight: 8,
  ...
  cardTitle: { fontSize: 22, fontWeight: 'bold', color: '#FF7A21', marginBottom: 8 },
  ...
  navWrapper: { position: 'absolute', bottom: 25, width: '100%', alignItems: 'center' },
  navBar: {
    flexDirection: 'row',
    backgroundColor: '#FFF',
    width: '85%',
